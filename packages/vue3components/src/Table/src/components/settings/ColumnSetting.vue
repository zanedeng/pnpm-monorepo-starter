...
import { Sortable, cloneDeep, isFunction, isNil, omit } from '@zkj/utils'
import { useRoute } from '@zkj/vue3router'
import { useI18n } from '@zkj/vue3locale'
import { DragOutlined, Icon, SettingOutlined } from '../../../../Icon'
import { getPopupContainer as getParentContainer } from '../../../../uitls'
...
const getPopupContainer = () => {
  return isFunction(attrs.getPopupContainer)
    ? (attrs.getPopupContainer as Function)()
    : getParentContainer()
}
...
// 默认值
let defaultIsIndexColumnShow = false
let defaultIsRowSelectionShow = false
