...
import type { EmitType, Recordable } from '@zkj/vue3types'
...
export function useDataSource(
  ...
  function deleteTableDataRecord(keyValues: Key | Key[]) {
    ...
    function deleteRow(data: any, keyValue: any) {
      ...
      function findRow(data: any[], keyValue: any): any {
  ...
  async function fetch(opt?: FetchParams): Promise<any> {
    ...
    try {
      ...
      let resultItems: Recordable[] = isArrayResult ? res : _get(res, listField)
