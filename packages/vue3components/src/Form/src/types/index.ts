...
interface _CustomComponents {
  ApiSelect: ExtractPropTypes<
    typeof import('../components/ApiSelect.vue')['default']
  >
  ApiTree: ExtractPropTypes<
    typeof import('../components/ApiTree.vue')['default']
  >
  ApiTreeSelect: ExtractPropTypes<
    typeof import('../components/ApiTreeSelect.vue')['default']
  >
  ApiRadioGroup: ExtractPropTypes<
    typeof import('../components/ApiRadioGroup.vue')['default']
  >
  RadioButtonGroup: ExtractPropTypes<
    typeof import('../components/RadioButtonGroup.vue')['default']
  >
  ApiCascader: ExtractPropTypes<
    typeof import('../components/ApiCascader.vue')['default']
  >
  ...
  Upload: ExtractPropTypes<
    typeof import('@/components/Upload/src/BasicUpload.vue')['default']
  >
  ...
  >
  ApiTransfer: ExtractPropTypes<
    typeof import('../components/ApiTransfer.vue')['default']
  >
...
export interface ComponentProps {
  ...
  InputGroup: ExtractPropTypes<
    typeof import('ant-design-vue/es/input')['InputGroup']
  >
  InputPassword: ExtractPropTypes<
    typeof import('ant-design-vue/es/input')['InputPassword']
  >
  InputSearch: ExtractPropTypes<
    typeof import('ant-design-vue/es/input')['InputSearch']
  >
  ...
  TreeSelect: ExtractPropTypes<
    typeof import('ant-design-vue/es/tree-select')['default']
  >
  ...
  RadioGroup: ExtractPropTypes<
    typeof import('ant-design-vue/es/radio')['RadioGroup']
  >
  Checkbox: ExtractPropTypes<
    typeof import('ant-design-vue/es/checkbox')['default']
  >
  CheckboxGroup: ExtractPropTypes<
    typeof import('ant-design-vue/es/checkbox')['CheckboxGroup']
  >
  AutoComplete: ExtractPropTypes<
    typeof import('ant-design-vue/es/auto-complete')['default']
  >
  ApiCascader: CustomComponents['ApiCascader'] & ComponentProps['Cascader']
  Cascader: ExtractPropTypes<
    typeof import('ant-design-vue/es/cascader')['default']
  >
  DatePicker: ExtractPropTypes<
    typeof import('ant-design-vue/es/date-picker')['default']
  >
  MonthPicker: ExtractPropTypes<
    typeof import('ant-design-vue/es/date-picker')['MonthPicker']
  >
  RangePicker: ExtractPropTypes<
    typeof import('ant-design-vue/es/date-picker')['RangePicker']
  >
  WeekPicker: ExtractPropTypes<
    typeof import('ant-design-vue/es/date-picker')['WeekPicker']
  >
  TimePicker: ExtractPropTypes<
    typeof import('ant-design-vue/es/time-picker')['TimePicker']
  >
  ...
  StrengthMeter: CustomComponents['StrengthMeter'] &
    ComponentProps['InputPassword']
  ...
  Divider: ExtractPropTypes<
    typeof import('ant-design-vue/es/divider')['default']
  >
  ApiTransfer: CustomComponents['ApiTransfer'] & ComponentProps['Transfer']
  Transfer: ExtractPropTypes<
    typeof import('ant-design-vue/es/transfer')['default']
  >
